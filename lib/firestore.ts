...
import { Project, Experience, Certification, Education, Skill, PersonalInfo } from '@/types'
...
export async function addCertification(certification: Omit<Certification, 'id'>): Promise<string> {
...
export async function updateCertification(id: string, certification: Partial<Certification>): Promise<void> {
...
export async function updatePersonalInfo(info: PersonalInfo): Promise<void> {
  await updateDoc(doc(db, 'personalInfo', 'main'), info)
}
