      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        ...
        <Card>
          <p className="text-cyber-cyan/90 mb-6 leading-relaxed">
            {personalInfo?.bio || 'Personal information not available'}
          </p>
          ...
          <div className="space-y-4">
            {personalInfo?.email && (
              <div className="flex items-center gap-2">
                <svg
                  className="w-5 h-5 text-cyber-green shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            {personalInfo?.location && (
              <div className="flex items-center gap-2">
                ...
                <span className="text-cyber-green font-mono text-sm uppercase">Location:</span>
                <span className="text-cyber-cyan">{personalInfo.location}</span>
              </div>
            )}
            
            {(personalInfo?.socialLinks || personalInfo?.website) && (
              <div className="flex flex-wrap items-center gap-4 mt-6">
                {personalInfo.socialLinks?.github && (
                  <a
                    ...
                    className="flex items-center gap-2 text-cyber-cyan hover:text-cyber-green transition-colors"
                    aria-label="GitHub"
                  >
